                    ...
                    <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                        <div>
                            <h1 className="text-xl font-semibold">
                                {mode === 'create'
                                    ? 'Create Case'
                                    : `Revise ${caseRecord?.docket_number}`}
                            </h1>
                            <p className="text-sm text-slate-600">
                                Docket number allocation remains server-controlled.
                            </p>
                        </div>
                        <Link
                        ...
                        denial_comments.map((denial) => (
                            ...
                            >
                                ...
                                <p className="mt-2 text-red-800">
                                    {denial.decided_by} | {denial.decided_at}
                                </p>
                            </div>
                        ))}
                    ...
                    <div className="mt-5 grid gap-4 md:grid-cols-2">
                        {can_select_prosecutor && (
                            <Field label="Prosecutor" error={errors.assigned_prosecutor_id}>
                                <select
                                    ...
                                    onChange={(event) =>
                                        setData('assigned_prosecutor_id', event.target.value)
                                    }
                                >
                        ...
                        <Field label="1st Hearing Date & Time" error={errors.hearing_date_1}>
                            <input
                                ...
                                onChange={(event) => setData('hearing_date_1', event.target.value)}
                            />
                        </Field>
                        <Field label="2nd Hearing Date & Time" error={errors.hearing_date_2}>
                            <input
                                ...
                                onChange={(event) => setData('hearing_date_2', event.target.value)}
                            />
                        </Field>
                                ...
                                <div className="grid gap-4 md:grid-cols-3">
                                    ...
                                    >
                                        <input
                                            ...
                                            onChange={(event) =>
                                                setParty(index, 'first_name', event.target.value)
                                            }
                                        />
                                    </Field>
                                    <Field
                                    ...
                                    >
                                        <input
                                            ...
                                            onChange={(event) =>
                                                setParty(index, 'middle_name', event.target.value)
                                            }
                                        />
                                    </Field>
                                    <Field
                                    ...
                                    >
                                        <input
                                            ...
                                            onChange={(event) =>
                                                setParty(index, 'last_name', event.target.value)
                                            }
                                        />
                                    </Field>
                                    <Field label="Suffix" error={errors[`parties.${index}.suffix`]}>
                                        <select
                                            ...
                                            value={party.suffix}
                                            onChange={(event) =>
                                                setParty(index, 'suffix', event.target.value)
                                            }
                                        >
                                    ...
                                    >
                                        <input
                                            ...
                                            onChange={(event) =>
                                                setParty(index, 'date_of_birth', event.target.value)
                                            }
                                        />
                                    </Field>
